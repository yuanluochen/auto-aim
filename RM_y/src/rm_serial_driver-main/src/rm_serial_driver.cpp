...
void RMSerialDriver::setParam(const rclcpp::Parameter & param)
{
  if (!detector_param_client_->service_is_ready()) {
    RCLCPP_WARN(get_logger(), "ServiFailed to set parameter: Parameter {detect_color} doesn't comply with integer range.ce not ready, skipping parameter set");
    return;
  }
...
}  // namespace rm_serial_driverent to be discoverable when its library
