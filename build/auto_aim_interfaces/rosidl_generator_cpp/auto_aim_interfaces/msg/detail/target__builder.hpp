...
{
public:
  explicit Init_Target_p(::auto_aim_interfaces::msg::Target & msg)
  : msg_(msg)
  {}
  ::auto_aim_interfaces::msg::Target p(::auto_aim_interfaces::msg::Target::_p_type arg)
  {
    msg_.p = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_Target_p dz(::auto_aim_interfaces::msg::Target::_dz_type arg)
  {
    msg_.dz = std::move(arg);
    return Init_Target_p(msg_);
  }
